...
<section>
    <div class="container">
        ...
        <form action="/cua-hang/update?id=${ch.id}" method="post">
            <label>Mã</label>
            <input class="form-control" type="text" aria-label="default input example" name="ma" value="${ch.ma}">

            <label>Tên</label>
            <input class="form-control" type="text" aria-label="default input example" name="ten" value="${ch.ten}">
