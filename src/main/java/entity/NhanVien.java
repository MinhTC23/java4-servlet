...
public class NhanVien {
    ...
    public NhanVien(String ma, String ten, String tenDem, String ho, String gioiTinh, java.sql.Date ngaySinh, String diaChi, String sdt, String matKhau, CuaHang cuaHang, ChucVu chucVu, String idGuiBC, Integer trangThai) {
        this.ma = ma;
        this.ten = ten;
        this.tenDem = tenDem;
        this.ho = ho;
